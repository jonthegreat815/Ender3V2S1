...
void Draw_Prepare_Menu() {
  checkkey = Menu;
  if (DWINUI::SetMenu(PrepareMenu, GET_TEXT_F(MSG_PREPARE), 12)) {
...
void Draw_Tramming_Menu() {
  DWINUI::ClearMenuArea();
  checkkey = Menu;
  if (DWINUI::SetMenu(TrammingMenu, GET_TEXT_F(MSG_BED_TRAMMING), 8)) {
...
void Draw_Control_Menu() {
  checkkey = Menu;
  if (DWINUI::SetMenu(ControlMenu, GET_TEXT_F(MSG_CONTROL), 10)) {
    MENU_ITEM(ICON_Back, GET_TEXT_F(MSG_BUTTON_BACK), onDrawMenuItem, Goto_Main_Menu);
...
void Draw_AdvancedSettings_Menu() {
  checkkey = Menu;
  if (DWINUI::SetMenu(AdvancedSettings, GET_TEXT_F(MSG_ADVANCED_SETTINGS), 22)) {
    MENU_ITEM(ICON_Back, GET_TEXT_F(MSG_BUTTON_BACK), onDrawMenuItem, Goto_Main_Menu);
    #if ENABLED(EEPROM_SETTINGS)
      MENU_ITEM(ICON_WriteEEPROM, GET_TEXT_F(MSG_STORE_EEPROM), onDrawMenuItem, WriteEeprom);
    #endif
...
void Draw_Move_Menu() {
  checkkey = Menu;
  if (DWINUI::SetMenu(MoveMenu, GET_TEXT_F(MSG_MOVE_AXIS), 5)) {
    MENU_ITEM(ICON_Back, GET_TEXT_F(MSG_BUTTON_BACK), onDrawMenuItem, Draw_Prepare_Menu);
  ...
  void Draw_HomeOffset_Menu() {
    checkkey = Menu;
    if (DWINUI::SetMenu(HomeOffMenu, GET_TEXT_F(MSG_SET_HOME_OFFSETS), 4)) {
  ...
  void Draw_ProbeSet_Menu() {
    checkkey = Menu;
    if (DWINUI::SetMenu(ProbeSetMenu, GET_TEXT_F(MSG_ZPROBE_SETTINGS), 11)) {
      MENU_ITEM(ICON_Back, GET_TEXT_F(MSG_BUTTON_BACK), onDrawMenuItem, Draw_AdvancedSettings_Menu);
      ...
      #endif
      #ifdef BLTOUCH_HS_MODE
        MENU_ITEM(ICON_HSMode, GET_TEXT_F(MSG_ENABLE_HS_MODE), onDrawHSMode, SetHSMode);
      #endif
...
void Draw_FilSet_Menu() {
    checkkey = Menu;
  if (DWINUI::SetMenu(FilSetMenu, GET_TEXT_F(MSG_FILAMENT_SET), 9)) {
      MENU_ITEM(ICON_Back, GET_TEXT_F(MSG_BUTTON_BACK), onDrawMenuItem, Draw_AdvancedSettings_Menu);
      #if HAS_FILAMENT_SENSOR
      ...
      #endif
      #if ProUIex
      MENU_ITEM(ICON_InvertE0, GET_TEXT_F(MSG_INVERT_EXTRUDER), onDrawInvertE0, SetInvertE0);
      #endif
      #if ENABLED(PREVENT_COLD_EXTRUSION)
    ...
    void Draw_ParkPos_Menu() {
      checkkey = Menu;
      if (DWINUI::SetMenu(ParkPosMenu, GET_TEXT_F(MSG_FILAMENT_PARK_ENABLED), 4)) {
        MENU_ITEM(ICON_Back, GET_TEXT_F(MSG_BUTTON_BACK), onDrawMenuItem, Draw_AdvancedSettings_Menu);
  ...
  void Draw_PhySet_Menu() {
    checkkey = Menu;
    if (DWINUI::SetMenu(PhySetMenu, GET_TEXT_F(MSG_PHY_SET), 8)) {
      MENU_ITEM(ICON_Back, GET_TEXT_F(MSG_BUTTON_BACK), onDrawMenuItem, Draw_AdvancedSettings_Menu);
...
void Draw_SelectColors_Menu() {
  checkkey = Menu;
  if (DWINUI::SetMenu(SelectColorMenu, GET_TEXT_F(MSG_COLORS_SELECT), 20)) {
    MENU_ITEM(ICON_Back, GET_TEXT_F(MSG_BUTTON_BACK), onDrawMenuItem, Draw_AdvancedSettings_Menu);
...
void Draw_GetColor_Menu() {
  checkkey = Menu;
  if (DWINUI::SetMenu(GetColorMenu, GET_TEXT_F(MSG_COLORS_GET), 5)) {
  ...
  void Draw_CaseLight_Menu() {
    checkkey = Menu;
    if (DWINUI::SetMenu(CaseLightMenu, GET_TEXT_F(MSG_CASE_LIGHT), 3)) {
    ...
    void Draw_LedControl_Menu() {
      checkkey = Menu;
      if (DWINUI::SetMenu(LedControlMenu, GET_TEXT_F(MSG_LED_CONTROL), 6)) {
        MENU_ITEM(ICON_Back, GET_TEXT_F(MSG_BUTTON_BACK), onDrawMenuItem, Draw_Control_Menu);
        #if !BOTH(CASE_LIGHT_MENU, CASE_LIGHT_USE_NEOPIXEL)
...
void Draw_Tune_Menu() {
  checkkey = Menu;
  if (DWINUI::SetMenu(TuneMenu, GET_TEXT_F(MSG_TUNE), 13)) {
...
void Draw_Motion_Menu() {
  checkkey = Menu;
  if (DWINUI::SetMenu(MotionMenu, GET_TEXT_F(MSG_MOTION), 6)) {
    MENU_ITEM(ICON_Back, GET_TEXT_F(MSG_BUTTON_BACK), onDrawMenuItem, Draw_Control_Menu);
  ...
  void Draw_FilamentMan_Menu() {
    checkkey = Menu;
    if (DWINUI::SetMenu(FilamentMenu, GET_TEXT_F(MSG_FILAMENT_MAN), 5)) {
      MENU_ITEM(ICON_Back, GET_TEXT_F(MSG_BUTTON_BACK), onDrawMenuItem, Draw_Prepare_Menu);
  ...
  void Draw_ManualMesh_Menu() {
    checkkey = Menu;
    if (DWINUI::SetMenu(ManualMesh, GET_TEXT_F(MSG_UBL_MANUAL_MESH), 6)) {
      MENU_ITEM(ICON_Back, GET_TEXT_F(MSG_BUTTON_BACK), onDrawMenuItem, Draw_Prepare_Menu);
  ...
  void Draw_Preheat1_Menu() {
    HMI_value.Preheat = 0;
    Draw_Preheat_Menu(DWINUI::SetMenu(PreheatMenu, GET_TEXT_F(MSG_PREHEAT_1_SETTINGS), 5));
  }

  void Draw_Preheat2_Menu() {
    HMI_value.Preheat = 1;
    Draw_Preheat_Menu(DWINUI::SetMenu(PreheatMenu, GET_TEXT_F(MSG_PREHEAT_2_SETTINGS), 5));
  }

  #ifdef PREHEAT_3_LABEL
    void Draw_Preheat3_Menu() {
      HMI_value.Preheat = 2;
      Draw_Preheat_Menu(DWINUI::SetMenu(PreheatMenu, GET_TEXT_F(MSG_PREHEAT_3_SETTINGS), 5));
    }
  #endif
...
void Draw_Temperature_Menu() {
  checkkey = Menu;
  if (DWINUI::SetMenu(TemperatureMenu, GET_TEXT_F(MSG_TEMPERATURE), 7)) {
    MENU_ITEM(ICON_Back, GET_TEXT_F(MSG_BUTTON_BACK), onDrawMenuItem, Draw_Control_Menu);
    #if HAS_HOTEND
...
void Draw_MaxSpeed_Menu() {
  checkkey = Menu;
  if (DWINUI::SetMenu(MaxSpeedMenu, GET_TEXT_F(MSG_MAXSPEED), 5)) {
...
void Draw_MaxAccel_Menu() {
  checkkey = Menu;
  if (DWINUI::SetMenu(MaxAccelMenu, GET_TEXT_F(MSG_ACCELERATION), 5)) {
    MENU_ITEM(ICON_Back, GET_TEXT_F(MSG_BUTTON_BACK), onDrawMenuItem, Draw_Motion_Menu);
  ...
  void Draw_MaxJerk_Menu() {
    checkkey = Menu;
    if (DWINUI::SetMenu(MaxJerkMenu, GET_TEXT_F(MSG_JERK), 5)) {
      MENU_ITEM(ICON_Back, GET_TEXT_F(MSG_BUTTON_BACK), onDrawMenuItem, Draw_Motion_Menu);
...
void Draw_Steps_Menu() {
  checkkey = Menu;
  if (DWINUI::SetMenu(StepsMenu, GET_TEXT_F(MSG_STEPS_PER_MM), 5)) {
    MENU_ITEM(ICON_Back, GET_TEXT_F(MSG_BUTTON_BACK), onDrawMenuItem, Draw_Motion_Menu);
  ...
  void Draw_HotendPID_Menu() {
    checkkey = Menu;
    if (DWINUI::SetMenu(HotendPIDMenu, F(STR_HOTEND_PID " Settings"),8)) {
      MENU_ITEM(ICON_Back, GET_TEXT_F(MSG_BUTTON_BACK), onDrawMenuItem, Draw_AdvancedSettings_Menu);
  ...
  void Draw_BedPID_Menu() {
    checkkey = Menu;
    if (DWINUI::SetMenu(BedPIDMenu, F(STR_BED_PID " Settings"),8)) {
      MENU_ITEM(ICON_Back, GET_TEXT_F(MSG_BUTTON_BACK), onDrawMenuItem, Draw_AdvancedSettings_Menu);
  ...
  void Draw_ZOffsetWiz_Menu() {
    checkkey = Menu;
    if (DWINUI::SetMenu(ZOffsetWizMenu, GET_TEXT_F(MSG_PROBE_WIZARD), 4)) {
      MENU_ITEM(ICON_Back, GET_TEXT_F(MSG_BUTTON_BACK), onDrawMenuItem, Draw_Prepare_Menu);
      MENU_ITEM(ICON_Homing, GET_TEXT_F(MSG_AUTO_HOME), onDrawMenuItem, AutoHome);
  ...
  void Draw_Homing_Menu() {
    checkkey = Menu;
    if (DWINUI::SetMenu(HomingMenu, GET_TEXT_F(MSG_HOMING), 5)) {
      MENU_ITEM(ICON_Back, GET_TEXT_F(MSG_BUTTON_BACK), onDrawMenuItem, Draw_Prepare_Menu);
      MENU_ITEM(ICON_Homing, GET_TEXT_F(MSG_AUTO_HOME), onDrawMenuItem, AutoHome);
  ...
  void Draw_FWRetract_Menu() {
    checkkey = Menu;
    if (DWINUI::SetMenu(FWRetractMenu, GET_TEXT_F(MSG_FWRETRACT), 6)) {
      MENU_ITEM(ICON_Back, GET_TEXT_F(MSG_BUTTON_BACK), onDrawMenuItem, Return_FWRetract_Menu);
